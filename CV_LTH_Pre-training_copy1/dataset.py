...
def cub_dataloaders(batch_size=64,data_dir='/usr/workspace/RML-data/data/cub/'):
    ...
    train_data = cub200(data_dir, train=True, transform=transforms.Compose(train_transform_list))
    val_data = cub200(data_dir, train=False, transform=transforms.Compose(test_transforms_list))
    test_data = cub200(data_dir, train=False, transform=transforms.Compose(test_transforms_list))
    ...
    return train_loader, val_loader, test_loader
def imagenet_dataloaders(batch_size=64, data_dir = '/usr/workspace/RML-data/data/imagenet/'):
...
def imagenetc_dataloaders(batch_size=64, data_dir = '/usr/workspace/RML-data/data/imagenet/'):
